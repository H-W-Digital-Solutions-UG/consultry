    ...
    <div className="space-y-8">
      <div className="grid gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(20rem,31rem)] lg:items-start lg:gap-12">
        <div className="max-w-[43rem]">
          ...
          <h2 className="mt-5 max-w-[11ch] text-balance text-[clamp(2.3rem,5vw,4rem)] font-semibold leading-[0.95] tracking-[-0.05em] text-[rgba(250,250,249,0.98)]">
          ...
          <p className="mt-5 max-w-[39rem] text-[15px] leading-[1.8] text-[rgba(232,228,238,0.74)] sm:text-[16px]">
            ...
            bis Sie Statistik ausdruecklich erlauben. Diese Seite zeigt den aktuellen Aufbau und
            gibt Ihnen jederzeit einen direkten Zugriff auf die Cookie-Einstellungen.
          </p>
      ...
      <section className="surface-panel rounded-[30px] border border-[rgba(255,255,255,0.08)] bg-[linear-gradient(180deg,rgba(24,21,28,0.98)_0%,rgba(20,18,24,0.98)_100%)] px-5 py-6 sm:px-7 sm:py-7">
      ...
      <p className="text-sm text-[var(--consultry-text-faint)]">Stand: April 2026</p>
    </div>
  );
}
