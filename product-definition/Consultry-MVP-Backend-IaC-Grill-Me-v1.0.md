...
**Bezug:** [Backend/IaC Design](./Consultry-MVP-Backend-IaC-Software-Design-v1.0.md), [AWS & Hermes Architecture](./Consultry-MVP-AWS-Hermes-Architecture-v1.0.md), [MVP-PRD](./Consultry-MVP-PRD-v1.0.md), [Business-Domain-Definition](./Consultry-Business-Domain-Definition-v1.0.md).
...
### G7 - Bedrock Knowledge Bases nicht als hartes Citation-Gate

**Befund:** Bedrock Knowledge Bases koennen nuetzlich sein, aber Consultrys rechtliche Invariante ist Claim -> CitationLink -> Span.
...
4. Hat jeder Firm-/External-Fact eine CitationLink-Kette bis Dokument/Span?
