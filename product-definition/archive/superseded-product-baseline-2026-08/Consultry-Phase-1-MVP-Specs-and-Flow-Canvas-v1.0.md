...
| **F4→Concept Suite** | **Concept & Proposal Suite (★HERO★)** | Aus Opportunity + Korpus + TeamShape + AwardCriteria → reviewfähiger, editierbarer Konzept-/Angebots-Entwurf mit sichtbarem Evidence-/Review-State. Consultant-as-author. Kein Versand. | PW1, PW2, PW6, PW7 |
...
- **Hero 1 (Win):** ≥ 1 reviewfähiger Konzept-/Bid-Entwurf aus eigenem Korpus **in 5 Tagen**; Edit-Distanz sinkend; Time-to-first-Wow < 15 Min.
...
- **Gemeinsam:** AI-Empfehlungen als brauchbare, nachvollziehbare Entscheidungshilfe akzeptiert (nicht Black Box); Design-Partner versteht den Kaufgrund in Minuten.
...
- **Concept & Proposal Canvas** (Hero) — reviewfähiger, editierbarer Entwurf mit Version History, Evidence-/Review-State und Citation-Hover, wo Quellen vorliegen.
...
- Anteil aktivierter Opportunities mit vollständiger Begründung sowie geklärtem Evidence-/Review-State für materielle Claims (Ziel für High-Risk Claims: 100 % geklärt oder bewusst akzeptiert).
...
- AI-Skill `draft-proposal` (F2/F3): erzeugt Gliederung + Kerntext aus Opportunity-Begründung + angehängten Assets; materielle Claims erhalten Evidence-/Review-State.
...
- **Herkunfts-/Review-Status**: verdichtete Bausteine zeigen relevante Herkunft oder offenen Review-Bedarf; methodische Inhalte brauchen keine pauschale Citation.
...
- Anteil materieller Empfehlungen mit sichtbarer Quelle oder offenem Review-Status (Qualitätsziel, kein globaler Hard Pass).
