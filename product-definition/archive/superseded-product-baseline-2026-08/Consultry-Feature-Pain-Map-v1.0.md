...
| **PK8** | **Parallele Projekte lösen strukturell gleiche Probleme mehrfach.** Die Arbeit kann fakturierbar sein, bleibt aber ohne Pattern-Erkennung, Assetization und Service-Productization individuelle Projektleistung statt skalierbarer Firmenfähigkeit; Delivery-Zeit, Qualität und Marge lernen nicht systematisch. | † (Discovery-/Dogfood-Hypothese) | Product Vision §1.6; Project Intelligence v1.1 |
...
|---|---|---|---|---|---|
| **Concept & Proposal Suite** (Hero) | PW1, PW2, PW6 | K, S, T | 🟦 | Reviewfähiger Konzept-/Angebots-Entwurf in Minuten statt Tagen, auf Zuschlagskriterien getrimmt. | **5-Tage-Draft** |
...
| **Provenienz/Review + CitationLink** | PW7 | T, K | ⬛ | Materielle Claims zeigen Evidenz- oder Review-Status; High-Risk Externalization bleibt menschlich/policy-gated. | beide (Vertrauen) |
...
| **Project Symbiosis, Assetization & Reuse Productization** | PK4, PK6, PK8, PW6 | S, L, K, T, M | 🟩/⬛ | Erklärt parallele Problem Patterns, validiert Reuse Candidates, erzeugt nach Rights-/Fachreview versionierte Assets, empfiehlt Anwendungen und verbindet wiederholbare Assets mit Service Bundles sowie Delivery-/Quality-/Margin-Learning. | tägliche Work-Adoption + Corpus/Asset Compounding + wirtschaftlicher Outcome |
