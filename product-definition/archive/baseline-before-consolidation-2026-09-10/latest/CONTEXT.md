...
Die folgenden deutschen Begriffe zur Wissensintegration ergänzen das Glossar anhand der direkten Nutzerpräzisierung vom 04.09.2026; ihre Herkunft und die noch offenen technischen Entscheidungen sind in `_CONTEXT-AND-MEMORY.md` festgehalten.

## Wissensintegration und Nutzung des Kerns

**Consultry Core / Consultry-Kern**:
Der gemeinsame Produktkern, der das Wissen und die Arbeitszusammenhänge einer Beratung für berechtigte Menschen, Anwendungen und Harnesses nutzbar macht.
_Nicht gleichsetzen mit_: UI, einzelne Agentensitzung, bestimmte Graph-Datenbank

**Wissensintegration**:
Das einfache Einbringen oder Anbinden von Wissensquellen über die UI, damit der Consultry-Kern sie unter den geltenden Zugriffsregeln verarbeiten, verknüpfen und nutzbar machen kann.
_Nicht gleichsetzen mit_: manuelle Graphpflege, automatische fachliche Freigabe aller abgeleiteten Aussagen

**Rollenbasierter Wissenszugriff**:
Die technische Zugriffssteuerung auf Consultry-Wissen anhand zugewiesener Zugriffsrollen innerhalb des jeweils erlaubten Organisations-, Klienten- und Projektkontexts.
_Nicht gleichsetzen mit_: bloßes Jobtitel-Label, geschäftliche Entscheidungsautorität, Zugriff auf sämtliches Firmenwissen

**Frontier-bevorzugte sensible AI-Verarbeitung**:
Consultry nutzt für eine Aufgabe das leistungsfähigste qualifizierte Modell, dessen konkreter Verarbeitungsweg für Zweck, Datenklasse, Zugriffsraum und Mandantenrichtlinie zulässig ist. Die Zulässigkeit umfasst nicht nur das Modell, sondern auch Vertrag, Region, Aufbewahrung, Training, Anbieterzugriff, Caches, Tools und nachgelagerte Dienste.
_Nicht gleichsetzen mit_: sensible Daten pauschal an das stärkste verfügbare Modell senden, feste Bindung an einen Anbieter, „kein Training“ als vollständiger Datenschutzbeleg

**Shared Co-Work Context / gemeinsamer Arbeitskontext**:
Der langlebige, mit realer Beratungsarbeit verbundene Kontext, in dem mehrere berechtigte Menschen und AI Execution Subjects am selben fachlichen Gegenstand, Ziel und Arbeitsstand mitwirken können. Projekt-, Case-, Task-, Plan- oder Artefaktbezug bleiben erkennbar; Group Chat, Agent Run, App, API und Harness sind mögliche Interaktionen mit diesem Kontext und keine voneinander unabhängigen Wahrheiten.
_Nicht gleichsetzen mit_: gemeinsamer Prompt für alle, identischer Rohdatenzugriff aller Beteiligten, Chatverlauf als Projekt-Source-of-Truth, maschinelle Teilnahme als Business Authority
...
- **Wissensintegration** führt Quellen dem **Consultry-Kern** zu; UI, API und Harness sind unterschiedliche Zugangswege zu diesem Kern, keine voneinander unabhängigen Wissensbestände.
- **Rollenbasierter Wissenszugriff** gilt bei UI-, API- und Harness-Nutzung gleichermaßen; ein Harness erhält durch den Zugangsweg keine zusätzlichen Rechte.
- **Frontier-bevorzugte sensible AI-Verarbeitung** folgt dem Prinzip der maximal zulässigen Intelligenz: Erst werden berechtigter Wissensausschnitt und Processing Envelope bestimmt, dann wird ein qualifizierter Modellweg gewählt. Ein Frontier-Modell erhält nicht automatisch den Gesamtkorpus; abgeleitete Kontexte und Resultate erben Schutzbedarf und Provenienz.
- Ein **Shared Co-Work Context** verbindet mehrere menschliche und maschinelle Beiträge mit demselben fachlichen Arbeitsstand. „Shared“ bezeichnet die gemeinsame Arbeitsrealität, nicht gleiche Sichtbarkeit: Jede Identität erhält nur ihre aktuell berechtigte, zweckgebundene Projektion und ein AI Execution Subject nur seine laufbezogene Context Capsule.
- Beiträge im **Shared Co-Work Context** bleiben der handelnden Person oder dem konkreten AI Execution Subject zurechenbar. Teilnahme, Erwähnung, Agentenkonsens oder Zugriff erzeugen weder accountable Responsibility noch Authority Grant; mehrere Agents bilden keinen unabhängigen Evidenzbeleg.
- Abgeleitete Wissensbeziehungen und bereitgestellter Kontext unterliegen ebenso den geltenden Zugriffsgrenzen wie ihre Quellen; technische Verarbeitung ist nicht mit **Corpus Admission** als fachlicher Freigabe gleichzusetzen.
