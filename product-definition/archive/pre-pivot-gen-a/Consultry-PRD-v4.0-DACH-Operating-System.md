...
> **⚠️ SUPERSEDED ALS PRODUKT-SOURCE-OF-TRUTH (Stand 13.06.2026).** Dieses Dokument (18.04.2026) beschreibt das **volle DACH-Operating-System vor dem Acquisition-to-Bid-Pivot**. Es ist **kein** MVP-Scope. Verbindlich sind: [MVP-Foundation-Decisions v1.0](../../latest/Consultry-MVP-Foundation-Decisions-v1.0.md) → [MVP-PRD v1.0](../superseded-product-baseline-2026-08/Consultry-MVP-PRD-v1.0.md) → [Business-Domain-Definition](../../latest/Consultry-Business-Domain-Definition-v1.0.md) → [GTM-Decisions](../../latest/Consultry-GTM-Decisions-v1.0.md). **Rolle heute:** H2/H3-Vision-Referenz (volles Modul-Set, Phasen-Roadmap). Referenziert `PRD-v3.0` und `Module-Refinement-v1.0`, die im Haupt-Tree **nicht existieren** (nur in git-Worktrees).
