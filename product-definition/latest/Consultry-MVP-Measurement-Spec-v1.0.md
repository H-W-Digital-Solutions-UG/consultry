...
**Status:** Active measurement candidate; becomes an acceptance baseline only after problem, journey, outcome and first-slice ratification. Numeric Work thresholds remain design-partner-calibrated hypotheses where marked.  
**Date:** 28.06.2026  
...
**Related:** [Alignment Control Plane](./Consultry-Alignment-Control-Plane-v1.0.md), [MVP-PRD](../archive/superseded-product-baseline-2026-08/Consultry-MVP-PRD-v1.0.md), [GTM Decisions](./Consultry-GTM-Decisions-v1.0.md).
...
| Level | Metric | Gate |
|---|---|---|
| Survival signal | Opportunity-to-Concept proof slice | At least one real, review-ready concept/proposal section from own corpus in five business days. |
| Trust gate | Material-claim review coverage | Every High-Risk claim used externally has a valid SourceBinding or an explicitly resolved/accepted review state. |
...
| `otc_five_day_draft` | Product | AuditEvent + artifact timestamp | approved pilot start to review-ready draft section timestamp | <= 5 business days |
...
| `material_claim_review_coverage` | Engineering | validation report | High-Risk claims with valid source or explicitly resolved/accepted review state / High-Risk claims | 100% before external use |
| `unresolved_high_risk_claim_count` | Engineering | validation report | unresolved High-Risk claims included in externalized artifact | 0 externalized; internal draft may persist |
...
| Most High-Risk claims remain unresolved before external use | Corpus/proof setup or review workflow insufficient | Improve onboarding ritual, Proof/Evidence Pack and review UX |
