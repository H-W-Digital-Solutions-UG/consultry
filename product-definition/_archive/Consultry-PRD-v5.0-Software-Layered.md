...
**Status:** ⚠️ **ARCHIVIERT (12.06.2026)** — superseded durch [MVP-PRD v1.0](../Consultry-MVP-PRD-v1.0.md) (Acquisition-to-Bid) + [MVP-Foundation-Decisions v1.0](../Consultry-MVP-Foundation-Decisions-v1.0.md) (T1)
**Datum:** 8. Mai 2026
...
**Ende v5.0.** ~~Dieses Dokument ist die Quelle der Wahrheit für die Architektur.~~ **Archiviert 12.06.2026** — Quelle der Wahrheit sind [MVP-PRD v1.0](../Consultry-MVP-PRD-v1.0.md) + [MVP-Foundation-Decisions v1.0](../Consultry-MVP-Foundation-Decisions-v1.0.md).
